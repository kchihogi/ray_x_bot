...
def main():
    ...
    parser.add_argument("-es","--email_server", type=str, required=False, default=os.environ['EMAIL_SERVER'], help="Server of email to send. Default is from environment variable EMAIL_SERVER")
    parser.add_argument("-ep","--email_port", type=int, required=False, default=os.environ['EMAIL_PORT'], help="Port of email to send. Default is from environment variable EMAIL_PORT")
    parser.add_argument("-ef","--email_from", type=str, required=False, default=os.environ['EMAIL_FROM'], help="From of email to send. Default is from environment variable EMAIL_FROM")
    parser.add_argument("-ps","--email_password", type=str, required=False, default=os.environ['EMAIL_PASSWORD'], help="Password of email to send. Default is from environment variable EMAIL_PASSWORD")
    parser.add_argument("-et","--email_to", type=str, required=False, default=os.environ['EMAIL_TO'], help="To of email to send. Default is from environment variable EMAIL_TO")
    parser.add_argument("-su","--email_subject", type=str, required=False, default=os.environ['EMAIL_SUBJECT'], help="Subject of email to send. Default is from environment variable EMAIL_SUBJECT")
    parser.add_argument("-bo","--email_body", type=str, required=False, default=os.environ['EMAIL_BODY'], help="Body of email to send. Default is from environment variable EMAIL_BODY")
