...
if __name__ == "__main__":
    ...
    db.insert("tweets", "text, created_at", "'Goodbye, world!','2021-01-01 00:00:01'")
    print(db.select("tweets", "*"))
    print(db.select("tweets", "*", "id=1"))
    print(db.select("tweets", "*", "text='Goodbye, world!'"))
    db.update("tweets", "text='Hello again, world!'", "id=1")
    print(db.select("tweets", "*", "times=1"))
    db.disconnect()
